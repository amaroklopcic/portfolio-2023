      ...
      <div className="about-section">
        ...
        <div className="about-section-flex">
          <p style={{ fontSize: "1.1rem", marginTop: "1rem" }}>
            {"Hi, I'm Amar :)"}
            <br />
            <br />I love software and making things. My passion for software engineering came from a
            ...
            released into the world was an addon for video game called "Garry's Mod" when I was just
